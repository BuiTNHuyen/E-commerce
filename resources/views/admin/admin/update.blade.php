                    ...
                    <form role="form" action="" method="POST">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group {{ $errors->first('name') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" value="{{ $admin->name }}" name="name"  placeholder="Tên ...">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group {{ $errors->first('phone') ? 'has-error' : '' }}">
                                ...
                                <input type="tel" class="form-control" value="{{  $admin->phone }}"  name="phone"  placeholder="Điện thoại ...">
