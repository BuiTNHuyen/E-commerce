...
<div id="chat-container"><i class="fa-solid fa-comment"></i></div>
<div id="chat-components">
    <div class="chat-contain" id="chat-popup-layout">
        <div class="chat-form">
                ...
                <div class="chat-header-info">
                    <div class="chat-header-info-avatar" data-toggle="tooltip" data-placement="top" data-original-title="Chức năng">
                        <div class="chat-header-avatar">
                            <img id="chat-avatar-image" class="chat-avatar-image" src="https://img.freepik.com/free-psd/3d-illustration-person-with-sunglasses_23-2149436188.jpg?w=740&t=st=1715415975~exp=1715416575~hmac=ab8ed7f147b56c09ced92efadffc9518cbc0d60a308d433ae2c6271e6ff4c835" alt=""/>
                            <span class="chat-status online-status"></span>
                        </div>
                        <div class="header-chat-display">
                            <p id="header-chat-display-name" class="header-chat-display-name"><b>Admin</b></p>
                        </div>
                    </div>
            ...
            <div class="chat-body body-visible-message" style=""><div class="" id="chat-body-message-popup"></div></div>
            <div class="chat-footer-popup">
                ...
                <div id="btn-send-message" class="send-message"><i class="fa-solid fa-paper-plane"></i></div>
            </div>
        </div>
    </div>
</div>
...
<script>
    document.addEventListener("DOMContentLoaded", (event) => {
        ...
        const elementChatComponents = document.getElementById('chat-components')
    ...
    function handleSendMessage() {
        ...
        userData = JSON.parse(JSON.parse(sessionStorage.getItem("current_user")));
        dataEmit = {
            'user_name': userData.name,
            'user_id': userData.id,
            'user_email': userData.email,
            'user_avatar': 'https://t4.ftcdn.net/jpg/02/29/75/83/360_F_229758328_7x8jwCwjtBMmC6rgFzLFhZoEpLobB6L8.jpg',
            'is_admin': 0,
            'message': message
        };
    ...
    function configClientSocket() {
        socket.on('connect', function() {
            ...
            socket.on('connecting', function(data) {
                ...
                document.getElementById('header-chat-display-name').innerHTML = `<b>${data[0].user_name}</b>`;
                document.getElementById('chat-avatar-image').setAttribute('src', `${data[0].user_avatar}`);
            });
        });
